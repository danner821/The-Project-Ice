...
case 'career-defense':
  ...
  function normalizeLivingWorldDateKey(value) {
  ...
  function buildCanonicalProspectRankingSnapshot(weekKey = null) {
    const players = getScoutingProspectUniverse();
  ...
  async function repairKnownMeghanTryoutSnapshot() {
    /*
  ...
  const HIGH_SCHOOL_REAL_PROSPECTS_PER_CLASS = 12;
  ...
  function ensureExternalProspectWorld() {
    ...
    ensureHighSchoolRealProspectPipeline();
