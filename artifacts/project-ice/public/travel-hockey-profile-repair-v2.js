...
(() => {
  ...
  function restoreHsTeam(){if(Array.isArray(WorldEngine.state?.teams))WorldEngine.state.teams=WorldEngine.state.teams.filter(t=>t?.travelProfileAdapter!==true);const id=realCareerTeamId()||restoreTeamId;try{if(typeof Game!=='undefined'&&id)Game.teamTabSelectedTeamId=id;}catch(_){}return id;}
