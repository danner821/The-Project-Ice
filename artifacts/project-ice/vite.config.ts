...
const runtimeModulesPlugin = {
  ...
  transformIndexHtml(html: string) {
    ...
    if (!html.includes('/standalone-safe-area.css')) {
      html = html.replace(
        '</head>',
        '    <link rel="stylesheet" href="/standalone-safe-area.css?v=20260917-3" />\n  </head>',
      );
    }
    ...
    if (!html.includes('/travel-season-id-integrity.js')) scripts.push('    <script src="/travel-season-id-integrity.js"></script>');
    ...
    if (!html.includes('/high-school-season-boundary-integrity.js')) scripts.push('    <script src="/high-school-season-boundary-integrity.js?v=20260920-season-transition-3"></script>');
    ...
    if (!html.includes('/coach-lineup-reconcile.js')) scripts.push('    <script src="/coach-lineup-reconcile.js"></script>');
