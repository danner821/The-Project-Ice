...
const runtimeModulesPlugin = {
  ...
  transformIndexHtml(html: string) {
    ...
    if (!html.includes('/high-school-season-boundary-integrity.js')) scripts.push('    <script src="/high-school-season-boundary-integrity.js?v=20260920-season-transition-5"></script>');
